...
from pybeamline.sources.ocel_log_source import ocel_json_log_source_from_file
...
class TestOcelJsonLogSource(unittest.TestCase):
    def test_generate_ocel_source_from_file_with_wrong_path(self):
        ...
        with self.assertRaises(Exception) as context:
            ocel_json_log_source_from_file(test_file_path)
    ...
    def test_generate_ocel_source_from_file(self):
        ...
        ocel_source = ocel_json_log_source_from_file(test_file_path)
